<div class="box_content">
    ...
    <script type="text/javascript">
		jwplayer(<vte:value select="{video_holder_id|json_encode}" />).setup({
			...
			width: <vte:value select="{video_width}" />,
			controlbar:'bottom',
			backcolor:'181818',
			frontcolor:'EEEEEE',
			stretching:'fill'
        ...
        <div id="{video_holder_id}_{index}">
            ...
            <div class="item_holder">
                <div class="video_button">
                    <a href="#play" onclick="jwplayer('{video_holder_id}').playlistItem({index}-1);return false;" ><img src="{VIVVO_THEME}img/play_button_light.png" alt="{LNG_PLUGIN_VIDEO_BOX_PLAY}" title="{LNG_PLUGIN_VIDEO_BOX_PLAY}" /></a>
                </div>
