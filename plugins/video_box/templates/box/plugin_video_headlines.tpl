<div class="box box_video">
    ...
    <div class="headline_video_player">
        ...
        <vte:template>
        	<div class="headline_video_playlist">
				<script type="text/javascript">
					...
					jwplayer("box_video_headline_container").load(
						[
                ...
                <vte:foreach item="article" from="{article_list}" key="index">
                    ...
                    <div class="headline_video_item">
                        ...
                        <a href="#play" onclick="jwplayer('box_video_headline_container').playlistItem({index}-1);return false;"><img src="{VIVVO_THEME}img/play_button.png" class="play_video" alt="{LNG_PLUGIN_VIDEO_BOX_PLAY}" title="{LNG_PLUGIN_VIDEO_BOX_PLAY}" /></a>
                    </div>			
                </vte:foreach>
            </div>
        </vte:template>
