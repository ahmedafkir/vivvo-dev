<vte:template>
    ...
    <vte:box module="box_poll_list">
        <vte:template>
            <h1 class="page_title"><vte:value select="{LNG_PLUGIN_POLL_VIEW_ALL_POLLS}" /></h1>
                            ...
                            <vte:if test="{answer_list}">
                            	<div class="poll_box_holder">
                                    <div class="poll_box_header">
                                        <h3 class="box_title title_gray"><vte:value select="{poll.name}" /></h3>
                                        <h5 class="subtitle"><vte:value select="{poll.question}" /></h5>
                                    </div>
