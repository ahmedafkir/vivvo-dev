		...
		<div class="short_holder">
            <div class="blog_info">
                <vte:if test="{VIVVO_ARTICLE_SHOW_DATE}">
                    <div class="blog_date">
                        <p class="blog_month"><vte:value select="{article.created|format_date:'M'}" /></p>
                        <p class="blog_day"><vte:value select="{article.created|format_date:'d'}" /></p>
                        <p><vte:value select="{article.created|format_date:'Y'}" /></p>
                    </div>
                </vte:if>
			...
			<div class="blog_summary">
                ...
                <vte:if test="{article.image}">
                    <div class="image" style="width:{VIVVO_SUMMARY_LARGE_IMAGE_WIDTH}px;">
                        ...
                        <img src="{VIVVO_STATIC_URL}thumbnail.php?file={article.image}&amp;size=summary_large" alt="{image_caption}" />
