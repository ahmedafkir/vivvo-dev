<div id="box_archive_navigation" class="box">
	<div class="box_title_holder"><div class="box_title">Navigate archive</div></div>
			...
			<vte:template>
				<vte:foreach from="{count_list}" item="counter">
					<div style="float:left;width:{width}px;">
						<img src="{VIVVO_THEME}img/poll_bar.gif" style="height:{counter[count]}px;width:{width}px;" /><br />
