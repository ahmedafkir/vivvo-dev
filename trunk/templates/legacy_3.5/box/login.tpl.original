			...
			<div class="box_content">
				<vte:if test="!{CURRENT_USER}">
					...
					<div id="forgot_form_holder" style="display:none;">
						...
						<form action="index.php" id="forgot_password_form" method="post" onsubmit="vivvoForgotPasswordForm.sendData();return false;">
							<input type="hidden" name="SECURITY_TOKEN" value ="{VIVVO_SECURITY_TOKEN}" />
							...
							<div class="form_line"> 
								...
								<div class="formElement">
									<input class="text" type="text" name="LOGIN_email" value="" style=" width: 216px;" />
								</div>
							</div>
							<div class="form_line"> 
								<label> </label>
								<div class="formElement submit">
									<input type="submit" class="submit_button" name="login" value="{LNG_SUBMIT_BUTTON}" />
								</div>
							</div>
					...
					<vte:else>
						...
						<div class="edit_info"><a href="{VIVVO_PROXY_URL}usercp.html"><vte:value select="{LNG_EDIT_PERSONAL_INFORMATION}" /></a></div>
					</vte:else>
