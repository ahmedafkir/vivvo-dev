								...
								<vte:if test="{article.image}">
									<div class="headline_image">
										<a href="{article.get_href}">
                                            ...
                                            <img src="{VIVVO_STATIC_URL}thumbnail.php?file={article.get_image}&amp;size=article_medium" align="left" alt="{image_caption}" />
                                        </a>
										<div class="image_caption"><vte:value select="{article.get_image_caption}" /></div>
									</div>
								</vte:if>
								<div id="rotating_headlines_article_{index}" style="height:111px;">
									<h1>
