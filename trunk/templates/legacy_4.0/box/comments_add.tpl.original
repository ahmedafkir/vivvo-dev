							...
							<div class="bbcodebox">
								<div class="form_line">
									...
									<div class="formElement">
										...
										<textarea id="COMMENT_description" name="COMMENT_description" class="bbcodearea add_comment" rows="7" cols="40"> </textarea>
									</div>
								</div>
							</div>
							<vte:else>
								<div class="form_line">
									<label><vte:value select="{LNG_ADD_COMMENTS}" />:</label>
									<div class="formElement">
										<textarea class="add_comment" name="COMMENT_description" rows="7" cols="40" onfocus="this.value='';this.onfocus = null;"> </textarea>
									</div>
								</div>
							</vte:else>
						</vte:if>
