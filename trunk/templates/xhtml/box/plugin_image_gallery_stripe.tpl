    	...
    	<vte:if test="{image_list}">
			...
			<div id="image_gallery_stripe" class="image">
				<div id="image_gallery_stripe_body" class="box_stripes" style="width:{VIVVO_ARTICLE_MEDIUM_IMAGE_WIDTH}px;">
					...
					<div class="controls"> 
						<span class="section_next" onclick="image_gallery_glider.next();$('image_current').update(image_gallery_glider.current._index + 1);"><img src="{VIVVO_THEME}img/image_scroller_next.gif" alt="{LNG_PLUGIN_IMAGE_GALLERY_NEXT}" title="{LNG_PLUGIN_IMAGE_GALLERY_NEXT}" /></span>
						<span class="section_previous" onclick="image_gallery_glider.previous();$('image_current').update(image_gallery_glider.current._index + 1);"><img src="{VIVVO_THEME}img/image_scroller_back.gif" alt="{LNG_PLUGIN_IMAGE_GALLERY_PREV}" title="{LNG_PLUGIN_IMAGE_GALLERY_PREV}" /></span>
