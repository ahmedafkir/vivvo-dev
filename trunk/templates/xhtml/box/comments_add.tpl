					...
					<div id="post-reply" class="box">
						<vte:if test="!{CURRENT_USER}">
							...
							<div class="form_line">
								...
								<div class="formElement">
									<input name="COMMENT_email" class="text default_fields" type="text" value="{USER_MAIL}" />
								</div>
							</div>
							<div class="form_line">
								...
								<div class="form_line">
									...
									<div class="formElement">
										<ul class="bbc_buttons">
											<li><a href="javascript:;" class="tag_bold"><img src="{VIVVO_THEME}img/bbc_bold.png" alt="{LNG_COMMENTS_BBCODE_BOLD}" title="{LNG_COMMENTS_BBCODE_BOLD}" /></a></li>
											<li><a href="javascript:;" class="tag_italic"><img src="{VIVVO_THEME}img/bbc_italic.png" alt="{LNG_COMMENTS_BBCODE_ITALIC}" title="{LNG_COMMENTS_BBCODE_ITALIC}" /></a></li>
											<li><a href="javascript:;" class="tag_underline"><img src="{VIVVO_THEME}img/bbc_underline.png" alt="{LNG_COMMENTS_BBCODE_UNDERLINE}" title="{LNG_COMMENTS_BBCODE_UNDERLINE}" /></a></li>
											<li><a href="javascript:;" class="tag_quote"><img src="{VIVVO_THEME}img/bbc_quote.png" alt="{LNG_COMMENTS_BBCODE_QUOTE}" title="{LNG_COMMENTS_BBCODE_QUOTE}" /></a></li>
											<vte:if test="{CURRENT_USER}">
												...
												<li><a href="javascript:;" onclick="{bbc_link_onclick}"><img src="{VIVVO_THEME}img/bbc_link.png" alt="{LNG_COMMENTS_BBCODE_INSERT_LINK}" title="{LNG_COMMENTS_BBCODE_INSERT_LINK}" /></a></li>
											</vte:if>
										</ul>
										<vte:if test="{CURRENT_USER}">
						...
						<vte:if test="{VIVVO_COMMENTS_CAPTHA}">
							...
							<h4 class="title_comments"><span><vte:value select="{LNG_ADD_COMMENT_CAPTCHA}" /></span></h4>
							<div class="form_line">
								<label><vte:value select="{LNG_IMAGE}" />: </label>
								<div class="formElement">
									<img class="captcha-image" src="{VIVVO_PROXY_URL}imagecode.html?article_id={article.get_id}" alt="Captcha" />
								</div>
							</div>
							<div class="form_line">
