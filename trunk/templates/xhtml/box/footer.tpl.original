<vte:template>
	...
	<div class="footer">
		...
		<div class="static_footer">
			<img src="{VIVVO_ABSOLUTE_URL}cron_image.html" style="display:none;" alt="cron" title="cron" />
			...
			<vte:if test="{VIVVO_MODULES_FEED}">
				| <a href="{VIVVO_ABSOLUTE_URL|switch_format:'rss'}">Rss</a> / <a href="{VIVVO_ABSOLUTE_URL|switch_format:'atom'}">Atom</a>
			</vte:if>
			<vte:if test="{VIVVO_MODULES_PLAINTEXT}">
				| <a href="{VIVVO_ABSOLUTE_URL|switch_format:'txt'}"><vte:value select="{LNG_PLAIN_TEXT}" /></a>
			</vte:if>
			<vte:if test="{VIVVO_MODULES_ARCHIVE_VIEW}">
				| <a href="{VIVVO_ABSOLUTE_URL}archive"><vte:value select="{LNG_ARCHIVE}" /></a>
			</vte:if>
