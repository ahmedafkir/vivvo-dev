<vte:box module="box_calendar">
    <vte:template>
        ...
        <table width="100%" cellpadding="0" cellspacing="1">
            <caption>
                <span onclick="updateCallendar({prev_year}, 1);"><img src="{VIVVO_THEME}img/pagination_first.gif" alt="first" /></span>
                <span onclick="updateCallendar({prev_month_year}, {prev_month});"><img src="{VIVVO_THEME}img/pagination_back.gif" alt="first" /></span>
                ...
                <span onclick="updateCallendar({next_month_year}, {next_month});"><img src="{VIVVO_THEME}img/pagination_next.gif" alt="first" /></span>
                <span onclick="updateCallendar({next_year}, 1);"><img src="{VIVVO_THEME}img/pagination_last.gif" alt="first" /></span>
            </caption>
            <tr>
